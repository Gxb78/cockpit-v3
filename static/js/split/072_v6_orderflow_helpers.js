...
(function () {
  ...
  var SETTINGS_SCHEMA = {
    ...
    maxTrades:       { type: 'number', default: 100000, min: 100, max: 100000 },
    heatmapMaxFrames:{ type: 'number', default: 100000, min: 60, max: 100000 },
    footprintMaxCandles:{ type: 'number', default: 100000, min: 60, max: 100000 },
    footprintHistoryLookbackMinutes:{ type: 'number', default: 10080, min: 1, max: 100000 },
